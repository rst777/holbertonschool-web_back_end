#!/usr/bin/env python3
import asyncio
from 0-basic_async_syntax import wait_random  # Importation de la fonction wait_random

async def wait_n(n: int, max_delay: int):
    """
    Lance n coroutines wait_random avec le paramètre max_delay, et retourne une liste des délais obtenus.
    ...
    Retour :
        list : Une liste de n délais (float), dans l'ordre d'exécution des tâches.
    """
